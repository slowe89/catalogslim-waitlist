...
const BANDS = [
  { max: 39, label: "Flat dump" },
  { max: 69, label: "Partial diet" },
  { max: 89, label: "Fragile routing" },
  { max: 100, label: "Dieted + measured" },
];
...
function syncScore() {
  ...
  if (complete) {
    ...
    scoreInviteText.textContent = `Your Catalog Confusion Score is ${total} — ${bandFor(total)}. Share this score and your answers via the Priestley form.`;
